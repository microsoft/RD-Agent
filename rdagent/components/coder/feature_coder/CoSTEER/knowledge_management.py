...
class FactorRAGStrategyV1(RAGStrategy):
    ...
    def query(
        ...
        v1_query_former_trace_limit = FEATURE_IMPLEMENT_SETTINGS.v1_query_former_trace_limit
        v1_query_similar_success_limit = FEATURE_IMPLEMENT_SETTINGS.v1_query_similar_success_limit
        fail_task_trial_limit = FEATURE_IMPLEMENT_SETTINGS.fail_task_trial_limit
...
class FactorGraphRAGStrategy(RAGStrategy):
    ...
    def query(self, evo: EvolvableSubjects, evolving_trace: list[EvoStep]) -> QueriedKnowledge | None:
        conf_knowledge_sampler = FEATURE_IMPLEMENT_SETTINGS.v2_knowledge_sampler
