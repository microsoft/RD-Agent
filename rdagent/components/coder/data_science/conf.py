...
from rdagent.utils.env import CondaConf, DSDockerConf, Env, LocalEnv, DockerEnv, MLEBDockerConf
...
def get_ds_env(conf_type: Literal["kaggle", "mlebench"] = "kaggle") -> Env:
    ...
    if conf.env_type == "docker":
        ...
        env = LocalEnv(conf=CondaConf(conda_env_name=conf_type) if conf_type == "kaggle" else MLEBDockerConf(
