    ...
    def evaluate(
        ...
        **kwargs,
        ...
        system_prompt = (
            ...
            .render(scenario=self.scen.get_scenario_all_desc(target_task) if self.scen is not None else "No scenario description.")
        )
...
class FactorOutputFormatEvaluator(FactorEvaluator):
    def evaluate(
        ...
        system_prompt = (
            ...
            .render(scenario=self.scen.get_scenario_all_desc(implementation.target_task) if self.scen is not None else "No scenario description.")
        )
