    ...
    if check_command_exists("docker"):
        if check_command_execution("docker run hello-world"):
            ...
            if check_command_execution("sudo docker run hello-world"):
                ...
                logger.error(f"Docker status is exception, please check the docker configuration or reinstall it. Refs: https://docs.docker.com/engine/install/ubuntu/.")
    else:
        logger.warning(f"Docker is not installed, please install docker. Refs: https://docs.docker.com/engine/install/ubuntu/.")
