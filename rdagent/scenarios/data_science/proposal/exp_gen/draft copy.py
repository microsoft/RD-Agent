...
class DSDraftExpGenV2(ExpGen):
    ...
    def knowledge_gen(self) -> str:
        general_knowledge = T(".prompts_draft_v1:knowledge.general").r()
    ...
    def hypothesis_gen(
        ...
        sys_prompt = T(".prompts_draft_v1:hypothesis_gen.system").r(
            component_desc=component_desc
        )
        user_prompt = T(".prompts_draft_v1:hypothesis_gen.user").r(
            scenario_desc=scenario_desc,
            knowledge=knowledge,
    ...
    def task_gen(
        ...
        sys_prompt = T(".prompts_draft_v1:task_gen.system").r(
            task_output_format=component_info["task_output_format"],
            component_desc=component_desc,
            workflow_check=not pipeline and hypotheses[0].component != "Workflow",
        )
        user_prompt = T(".prompts_draft_v1:task_gen.user").r(
            scenario_desc=scenario_desc,
    ...
    def gen(self, trace: DSTrace) -> DSExperiment:
        ...
        # Step 3: Design Task
        return self.task_gen(component_desc,scenario_desc,hypothesis, pipeline, failed_exp_feedback_list_desc)
