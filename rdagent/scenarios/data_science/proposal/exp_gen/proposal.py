...
from rdagent.scenarios.data_science.proposal.exp_gen.draft import DSDraftExpGenV2
...
def draft_exp_in_decomposition(scen: Scenario, trace: DSTrace) -> None | DSDraftExpGenV2:
