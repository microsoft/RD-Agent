                        ...
                        "content": [
                            {
                                ...
                                "value_feedback": f.value_feedback if isinstance(f, CoSTEERSingleFeedbackDeprecated) else f.factor_value_feedback,
                                "model_shape_feedback": f.shape_feedback if isinstance(f, CoSTEERSingleFeedbackDeprecated) else None,
                            } for f in fl if f
                        ]
                    })
