...
class Workspace(ABC):
    ...
    def freeze(self) -> Workspace:
        """
        Detach the workspace from the task
        """
        pass
...
class ImpLoader(ABC, Generic[ASpecificTask, ASpecificWS]):
    @abstractmethod
...
class FBWorkspace(Workspace):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.code_dict = {}  # The code to be injected into the folder, store them in the variable
        self.workspace_folder_path = RD_AGENT_SETTINGS.workspace_folder_path / uuid.uuid4().hex
    ...
    def prepare(self, *args, **kwargs):
        ...
        """
        self.workspace_folder_path.mkdir(parents=True, exist_ok=True)
    ...
    def inject_code(self, **files: str):
        ...
        for k, v in files.items():
            self.code_dict[k] = v
            with open(self.workspace_folder_path / k, "w") as f:
                f.write(v)
...
class Experiment(ABC, Generic[ASpecificTask, ASpecificWS]):
    """
